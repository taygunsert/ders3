...
// 1- Ziyaretçinin tarayıcısında (local storage) daha önceden oluşturulmuş olan ziyaretSayisi anahtarı var mı ?
...
if (ziyaretSayac === null) {
  ...
  let adSoyad = prompt("Görünüşe göre sayfaya ilk kez giriyorsunuz, lütfen ad soyad giriniz: ");
